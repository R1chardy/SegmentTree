...
int main() {
    ...
    cout << "updating (0 -10)" << endl;
    test2.update(0, -10); // {-10,10,5,2,7,1,0,9}
    ...
    test2.update(3, 43); // {-10,10,5,43,7,1,0,9}
    ...
    test2.update(7, 44); // {-10,10,5,43,7,1,0,44}
    ...
    cout << "max from 3 to 4: " << test2.getMax(3, 4) << endl;
    cout << "max from 1 to 4: " << test2.getMax(1, 4) << endl;
    cout << "max from 3 to 6: " << test2.getMax(3, 6) << endl;
    cout << "max from 4 to 6: " << test2.getMax(4, 6) << endl;
